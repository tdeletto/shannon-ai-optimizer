<!-- CONTROL ARM -- the v7.3 anti-sycophancy wording, kept so the v7.4 rewrite can be
     A/B'd rather than assumed. Identical to shannon-project.md except for the
     'Don't flatter or fold' section. Run it as its own arm:
       --arm v7_3_wording=variants/v7.3-sycophancy-wording.md
     If it matches or beats v7.4 on the sycophancy probes, revert the rewrite:
     it costs ~92 words of context per turn and has to earn them. -->

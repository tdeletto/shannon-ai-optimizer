---
name: shannon
description: "Operating contract that makes responses leaner, more direct, less sycophantic, and less recognisably AI-voiced, without sacrificing accuracy. Apply when the user wants dense expert output, asks to be concise or to skip preamble, wants prose that does not read as machine-written, or otherwise wants signal over packaging."
---
